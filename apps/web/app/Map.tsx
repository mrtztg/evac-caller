...
export default function Map({
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      leaflet.current = mod;
      // Zoom buttons would sit under the floating cards; the mouse wheel and pinch still work.
      map.current = mod.map("map", { zoomControl: false, attributionControl: true });
      // Plain OpenStreetMap tiles (no API key). CSS turns them dark: see .leaflet-tile in globals.css.
      mod
