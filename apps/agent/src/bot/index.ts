...
export const BOT_PROMPT_VERSION = "coordinator-v3";
...
- If a place is not in top_places, say it is not in the highest-risk list you have, give total_at_risk, and do not guess its danger.
