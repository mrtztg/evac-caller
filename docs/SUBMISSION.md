...
- **pnpm + TypeScript monorepo**, Node 22. `packages/core` holds the pure logic (fire replay, wind, danger zone, places at risk, ranking) with 36 tests and no network calls in tests.
